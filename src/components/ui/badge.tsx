...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-3 py-1 text-sm font-semibold transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
        ...
        warning:
          "border-transparent bg-yellow-100 text-yellow-800 hover:bg-yellow-200 hover:shadow-md",
      },
    },
    defaultVariants: {
      variant: "default",
