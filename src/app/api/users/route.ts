...
export async function GET() {
  try {
    ...
    const users = userBusinesses.map((ub) => ({ id: ub.user.id, name: ub.user.name, email: ub.user.email, role: ub.role, isActive: ub.user.isActive, createdAt: ub.user.createdAt }));
